...
INSERT INTO `config_info` VALUES (37, 'integrity-gen-dev.yml', 'DEFAULT_GROUP', '# spring配置\nspring:\n  data:\n    redis:\n      host: localhost\n      port: 6379\n      password: \n  datasource:\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    url: jdbc:mysql://localhost:3306/integrity-cloud?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8\n    username: root\n    password: password\n\n# mybatis配置\nmybatis:\n    # 搜索指定包别名\n    typeAliasesPackage: com.integrity.gen.domain\n    # 配置mapper的扫描，找到所有的mapper.xml映射文件\n    mapperLocations: classpath:mapper/**/*.xml\n\n# springdoc配置\nspringdoc:\n  gatewayUrl: http://localhost:8080/${spring.application.name}\n  api-docs:\n    # 是否开启接口文档\n    enabled: true\n  info:\n    # 标题\n    title: \'代码生成接口文档\'\n    # 描述\n    description: \'代码生成接口描述\'\n    # 作者信息\n    contact:\n      name: Integrity-Supervision-Platform\n      url: https://integrity-supervision-platform.local\n\n# 代码生成\ngen:\n  # 作者\n  author: integrity\n  # 默认生成包路径 system 需改成自己的模块名称 如 system monitor tool\n  packageName: com.integrity.system\n  # 自动去除表前缀，默认是false\n  autoRemovePre: false\n  # 表前缀（生成类名不会包含表前缀，多个用逗号分隔）\n  tablePrefix: sys_\n  # 是否允许生成文件覆盖到本地（自定义路径），默认不允许\n  allowOverwrite: false', '669b20230daf5b2eddda1c87a1e755d7', '2026-07-07 14:34:19', '2026-07-07 14:34:19', 'nacos_namespace_migrate', '0:0:0:0:0:0:0:1', '', 'public', '代码生成', NULL, NULL, 'yaml', NULL, '');
INSERT INTO `config_info` VALUES (38, 'integrity-job-dev.yml', 'DEFAULT_GROUP', 'spring:\n  data:\n    redis:\n      host: localhost\n      port: 6379\n      password:\n  datasource:\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    url: jdbc:mysql://localhost:3306/integrity-cloud?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8\n    username: root\n    password: root\n\nmybatis:\n  typeAliasesPackage: com.integrity.job.domain\n  mapperLocations: classpath:mapper/**/*.xml\n\nspringdoc:\n  gatewayUrl: http://localhost:8080/${spring.application.name}\n  api-docs:\n    enabled: true\n  info:\n    title: Job API\n    description: Job API\n    contact:\n      name: Integrity-Supervision-Platform\n      url: https://integrity-supervision-platform.local\n', '9c261f8b8ab6ea7e115ef23b84efcbcd', '2026-07-07 14:34:19', '2026-07-08 12:50:38', 'fix_job_encoding', '192.168.206.196', '', 'public', '定时任务', NULL, NULL, 'yaml', NULL, '');
...
INSERT INTO `config_info` VALUES (47, 'integrity-flow-dev.yml', 'DEFAULT_GROUP', 'spring:\n  main:\n    allow-bean-definition-overriding: true\n  data:\n    redis:\n      host: 127.0.0.1\n      port: 6379\n      password:\n      database: 0\n  datasource:\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    url: jdbc:mysql://localhost:3306/integrity-cloud-flow?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8\n    username: root\n    password: root\n\nmybatis:\n  typeAliasesPackage: com.integrity.flow.domain\n  mapperLocations: classpath:mapper/**/*.xml\n\nspringdoc:\n  gatewayUrl: http://localhost:8080/${spring.application.name}\n  api-docs:\n    enabled: true\n  info:\n    title: Flow API\n    description: Flow API\n    contact:\n      name: Integrity-Supervision-Platform\n      url: https://integrity-supervision-platform.local\n\nwarm-flow:\n  enabled: true\n  banner: true\n  key_type: SnowId19\n  ui: true\n  token-name: Authorization\n', '34384b64ace2921f46cc022399c1ae32', '2026-07-07 14:38:00', '2026-07-08 00:35:11', 'nacos_namespace_migrate', '127.0.0.1', '', '', '定时任务', NULL, NULL, 'yaml', NULL, '');
INSERT INTO `config_info` VALUES (48, 'integrity-system-dev.yml', 'DEFAULT_GROUP', 'spring:\n  data:\n    redis:\n      host: localhost\n      port: 6379\n      password:\n  datasource:\n    druid:\n      stat-view-servlet:\n        enabled: true\n        loginUsername: admin\n        loginPassword: 123456\n    dynamic:\n      druid:\n        initial-size: 5\n        min-idle: 5\n        maxActive: 20\n        maxWait: 60000\n        connectTimeout: 30000\n        socketTimeout: 60000\n        timeBetweenEvictionRunsMillis: 60000\n        minEvictableIdleTimeMillis: 300000\n        validationQuery: SELECT 1 FROM DUAL\n        testWhileIdle: true\n        testOnBorrow: false\n        testOnReturn: false\n        poolPreparedStatements: true\n        maxPoolPreparedStatementPerConnectionSize: 20\n        filters: stat,slf4j\n        connectionProperties: druid.stat.mergeSql=true;druid.stat.slowSqlMillis=5000\n      datasource:\n          master:\n            driver-class-name: com.mysql.cj.jdbc.Driver\n            url: jdbc:mysql://localhost:3306/integrity-cloud?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8\n            username: root\n            password: root\n\nmybatis:\n  type-aliases-package: com.integrity.system\n  mapper-locations: classpath:mapper/**/*.xml\n\nspringdoc:\n  gatewayUrl: http://localhost:8080/${spring.application.name}\n  api-docs:\n    enabled: true\n  info:\n    title: System API\n    description: System API\n    contact:\n      name: Integrity-Supervision-Platform\n      url: https://integrity-supervision-platform.local\n', '7b60fdf13196dcf058a341ce7a977a3a', '2026-07-08 15:55:24', '2026-07-08 15:55:24', 'nacos_namespace_migrate', '192.168.1.12', '', 'public', '系统模块', NULL, NULL, 'yaml', NULL, '');
