...
public class SysRoleController extends BaseController
{
    ...
    @InnerAuth
    @GetMapping("/idMappingRoleName/{roleId}")
    public R<String> idMappingRoleName(@PathVariable(value = "roleId") String roleId)
    {
        SysRole sysRole = roleService.selectRoleById(roleId);
        if (sysRole == null)
        {
            return R.fail("角色:'" + roleId + "'，查询错误，请联系管理员");
        }
        return R.ok(sysRole.getRoleName());
    }
}
