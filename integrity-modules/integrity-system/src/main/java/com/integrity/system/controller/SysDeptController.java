...
public class SysDeptController extends BaseController
{
    ...
    @InnerAuth
    @GetMapping("/idMappingDeptName/{deptId}")
    public R<String> idMappingDeptName(@PathVariable(value = "deptId") String deptId)
    {
        SysDept sysDept = deptService.selectDeptById(deptId);
        if (sysDept == null)
        {
            return R.fail("部门:'" + deptId + "'，查询错误，请联系管理员");
        }
        return R.ok(sysDept.getDeptName());
    }
}
