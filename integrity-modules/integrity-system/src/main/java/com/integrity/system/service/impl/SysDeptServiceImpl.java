...
import com.integrity.system.mapper.SysDeptMapper;
...
public class SysDeptServiceImpl implements ISysDeptService
{
    ...
    public int insertDept(SysDept dept)
    {
        ...
        {
            dept.setDeptId(idGeneratorService.generateId("SD"));
        }
        ...
        else
        {
            ...
            if (StringUtils.isNull(info) || !UserConstants.DEPT_NORMAL.equals(info.getStatus()))
            {
