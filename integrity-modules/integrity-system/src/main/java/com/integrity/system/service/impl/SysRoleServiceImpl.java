...
import com.integrity.system.domain.SysRoleDept;
import com.integrity.system.domain.SysRoleMenu;
import com.integrity.system.domain.SysUserRole;
import com.integrity.system.mapper.SysRoleDeptMapper;
...
public class SysRoleServiceImpl implements ISysRoleService
{
    ...
    {
        String roleId = StringUtils.isNull(role.getRoleId()) ? StringUtils.EMPTY : role.getRoleId();
    ...
    public int insertRole(SysRole role)
    {
        ...
        {
            role.setRoleId(idGeneratorService.generateId("SR"));
        }
        // 新增角色信息
