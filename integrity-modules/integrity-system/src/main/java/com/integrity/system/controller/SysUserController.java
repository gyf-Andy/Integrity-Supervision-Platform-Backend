...
import com.integrity.common.security.service.TokenService;
import com.integrity.common.security.utils.SecurityUtils;
import com.integrity.system.api.domain.SysDept;
...
import com.integrity.system.service.ISysPermissionService;
import com.integrity.system.service.ISysPostService;
import com.integrity.system.service.ISysRoleService;
...
public class SysUserController extends BaseController
{
    ...
    @InnerAuth
    @GetMapping("/idMappingUserName/{userId}")
    public R<String> idMappingUserName(@PathVariable(value = "userId") String userId)
    {
        SysUser sysUser = userService.selectUserById(userId);
        if (sysUser == null)
        {
            return R.fail("用户:'" + userId + "'，查询错误，请联系管理员");
        }
    ...
    public R<List<SysUser>> findUserIdList(WarmFlowInteractiveTypeVo warmFlowInteractiveTypeVo)
    {
