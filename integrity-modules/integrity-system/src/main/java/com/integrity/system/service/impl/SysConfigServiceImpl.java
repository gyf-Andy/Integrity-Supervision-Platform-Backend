...
import com.integrity.system.domain.SysConfig;
import com.integrity.system.mapper.SysConfigMapper;
...
public class SysConfigServiceImpl implements ISysConfigService
{
    ...
    public int insertConfig(SysConfig config)
    {
        ...
        {
            config.setConfigId(idGeneratorService.generateId("SC"));
        }
    ...
    {
        String configId = StringUtils.isNull(config.getConfigId()) ? StringUtils.EMPTY : config.getConfigId();
